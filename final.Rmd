---
title: 'Simulation Over Three Major Indexes: Bootstrapping'
...
## Mean: Empirical Bootstrap

```{r Empirical Bootstrap}
# Empirical bootstrap of the mean and variance
emp_boot <- function(n, B, s, k, m) {
  # Create sample
  ...
  # Empirical Bootstrap
  for (i in 1:B) {
    BT_sample = sample(sample_vals, n, replace=TRUE)
